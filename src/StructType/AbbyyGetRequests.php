...
/**
 * This class stands for GetRequests StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetRequests extends AbstractStructBase
{
    /**
     * The batchId
     * @var int
    ...
    public $sessionId;
    /**
     * Constructor method for GetRequests
     * @uses AbbyyGetRequests::setBatchId()
     * @uses AbbyyGetRequests::setTaskId()
     * @uses AbbyyGetRequests::setSessionId()
     * @param int $batchId
     * @param int $taskId
     * @param int $sessionId
     */
    public function __construct($batchId = null, $taskId = null, $sessionId = null)
    {
        $this
            ->setBatchId($batchId)
            ->setTaskId($taskId)
     ...
     * Set batchId value
     * @param int $batchId
     * @return \AbbyyBridge\StructType\AbbyyGetRequests
     */
