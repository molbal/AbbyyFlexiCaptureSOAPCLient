...
/**
 * This class stands for LoadAttachmentResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyLoadAttachmentResponse extends AbstractStructBase
{
    /**
     * The file
    ...
    public $file;
    /**
     * Constructor method for LoadAttachmentResponse
     * @uses AbbyyLoadAttachmentResponse::setFile()
     ...
     * Set file value
     * @param \AbbyyBridge\StructType\AbbyyFile $file
     * @return \AbbyyBridge\StructType\AbbyyLoadAttachmentResponse
     */
