...
/**
 * This class stands for DeleteBatch StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyDeleteBatch extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $batchId;
    /**
     * Constructor method for DeleteBatch
     * @uses AbbyyDeleteBatch::setSessionId()
     * @uses AbbyyDeleteBatch::setBatchId()
     * @param int $sessionId
     * @param int $batchId
     */
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyDeleteBatch
     */
