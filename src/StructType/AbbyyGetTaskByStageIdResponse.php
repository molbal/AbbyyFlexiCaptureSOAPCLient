...
/**
 * This class stands for GetTaskByStageIdResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetTaskByStageIdResponse extends AbstractStructBase
{
    /**
     * The taskId
     * @var int
    ...
    public $taskId;
    /**
     * Constructor method for GetTaskByStageIdResponse
     * @uses AbbyyGetTaskByStageIdResponse::setTaskId()
     * @param int $taskId
     */
     ...
     * Set taskId value
     * @param int $taskId
     * @return \AbbyyBridge\StructType\AbbyyGetTaskByStageIdResponse
     */
