...
/**
 * This class stands for GetRoles StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetRoles extends AbstractStructBase
{
    /**
     * The projectId
     * @var int
    ...
    public $projectId;
    /**
     * Constructor method for GetRoles
     * @uses AbbyyGetRoles::setProjectId()
     * @param int $projectId
     */
     ...
     * Set projectId value
     * @param int $projectId
     * @return \AbbyyBridge\StructType\AbbyyGetRoles
     */
