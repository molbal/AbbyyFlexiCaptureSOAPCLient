...
/**
 * This class stands for LoadAttachment StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyLoadAttachment extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $fileName;
    /**
     * Constructor method for LoadAttachment
     * @uses AbbyyLoadAttachment::setSessionId()
     * @uses AbbyyLoadAttachment::setType()
     * @uses AbbyyLoadAttachment::setObjectId()
     * @uses AbbyyLoadAttachment::setBatchId()
     * @uses AbbyyLoadAttachment::setProjectId()
     * @uses AbbyyLoadAttachment::setFileName()
     * @param int $sessionId
     * @param int $type
     * @param int $objectId
     * @param int $batchId
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyLoadAttachment
     */
