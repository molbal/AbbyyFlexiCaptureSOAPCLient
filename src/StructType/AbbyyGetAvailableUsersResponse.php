...
/**
 * This class stands for GetAvailableUsersResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetAvailableUsersResponse extends AbstractStructBase
{
    /**
     * The users
    ...
    public $users;
    /**
     * Constructor method for GetAvailableUsersResponse
     * @uses AbbyyGetAvailableUsersResponse::setUsers()
     ...
     * Set users value
     * @param \AbbyyBridge\StructType\AbbyyUserList $users
     * @return \AbbyyBridge\StructType\AbbyyGetAvailableUsersResponse
     */
