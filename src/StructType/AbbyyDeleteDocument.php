...
/**
 * This class stands for DeleteDocument StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyDeleteDocument extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
     ...
     * @uses AbbyyDeleteDocument::setSessionId()
     * @uses AbbyyDeleteDocument::setBatchId()
     * @uses AbbyyDeleteDocument::setDocumentId()
     * @param int $sessionId
     * @param int $batchId
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyDeleteDocument
     */
