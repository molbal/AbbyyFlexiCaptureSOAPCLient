...
/**
 * This class stands for GetTaskInfo StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetTaskInfo extends AbstractStructBase
{
    /**
     * The taskId
     * @var int
    ...
    public $taskId;
    /**
     * Constructor method for GetTaskInfo
     * @uses AbbyyGetTaskInfo::setTaskId()
     * @param int $taskId
     */
     ...
     * Set taskId value
     * @param int $taskId
     * @return \AbbyyBridge\StructType\AbbyyGetTaskInfo
     */
