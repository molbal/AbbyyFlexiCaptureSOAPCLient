...
/**
 * This class stands for GetDocumentResultsList StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetDocumentResultsList extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $documentId;
    /**
     * Constructor method for GetDocumentResultsList
     * @uses AbbyyGetDocumentResultsList::setSessionId()
     * @uses AbbyyGetDocumentResultsList::setBatchId()
     * @uses AbbyyGetDocumentResultsList::setDocumentId()
     * @param int $sessionId
     * @param int $batchId
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyGetDocumentResultsList
     */
