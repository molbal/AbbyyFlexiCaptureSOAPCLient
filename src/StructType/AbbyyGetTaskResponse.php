...
/**
 * This class stands for GetTaskResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetTaskResponse extends AbstractStructBase
{
    /**
     * The taskId
     * @var int
     ...
     * @uses AbbyyGetTaskResponse::setTaskId()
     * @param int $taskId
     */
     ...
     * Set taskId value
     * @param int $taskId
     * @return \AbbyyBridge\StructType\AbbyyGetTaskResponse
     */
