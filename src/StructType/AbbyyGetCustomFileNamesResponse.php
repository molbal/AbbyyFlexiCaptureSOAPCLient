...
/**
 * This class stands for GetCustomFileNamesResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetCustomFileNamesResponse extends AbstractStructBase
{
    /**
     * The fileNames
    ...
    public $fileNames;
    /**
     * Constructor method for GetCustomFileNamesResponse
     * @uses AbbyyGetCustomFileNamesResponse::setFileNames()
     ...
     * Set fileNames value
     * @param \AbbyyBridge\StructType\AbbyyFileNames $fileNames
     * @return \AbbyyBridge\StructType\AbbyyGetCustomFileNamesResponse
     */
