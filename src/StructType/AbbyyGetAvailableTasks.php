...
/**
 * This class stands for GetAvailableTasks StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetAvailableTasks extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    /**
     * Constructor method for GetAvailableTasks
     * @uses AbbyyGetAvailableTasks::setSessionId()
     * @uses AbbyyGetAvailableTasks::setProjectId()
     * @uses AbbyyGetAvailableTasks::setProcessingStage()
     * @uses AbbyyGetAvailableTasks::setOnlyPrivateBatches()
     * @param int $sessionId
     * @param int $projectId
     * @param int $processingStage
     * @param bool $onlyPrivateBatches
     */
    public function __construct($sessionId = null, $projectId = null, $processingStage = null, $onlyPrivateBatches = null)
    {
        $this
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyGetAvailableTasks
     */
     ...
     * @return \AbbyyBridge\StructType\AbbyyGetAvailableTasks
     */
    public function setProcessingStage($processingStage = null)
    {
        // validation for constraint: int
        if (!is_null($processingStage) && !(is_int($processingStage) || ctype_digit($processingStage))) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide an integer value, %s given', var_export($processingStage, true), gettype($processingStage)), __LINE__);
        }
