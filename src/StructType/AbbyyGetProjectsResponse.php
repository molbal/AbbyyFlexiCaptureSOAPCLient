...
/**
 * This class stands for GetProjectsResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetProjectsResponse extends AbstractStructBase
{
    /**
     * The projects
    ...
    public $projects;
    /**
     * Constructor method for GetProjectsResponse
     * @uses AbbyyGetProjectsResponse::setProjects()
     ...
     * Set projects value
     * @param \AbbyyBridge\StructType\AbbyyProjects $projects
     * @return \AbbyyBridge\StructType\AbbyyGetProjectsResponse
     */
