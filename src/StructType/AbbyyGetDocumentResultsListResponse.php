...
/**
 * This class stands for GetDocumentResultsListResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetDocumentResultsListResponse extends AbstractStructBase
{
    /**
     * The fileNames
    ...
    public $fileNames;
    /**
     * Constructor method for GetDocumentResultsListResponse
     * @uses AbbyyGetDocumentResultsListResponse::setFileNames()
     ...
     * Set fileNames value
     * @param \AbbyyBridge\StructType\AbbyyFileNames $fileNames
     * @return \AbbyyBridge\StructType\AbbyyGetDocumentResultsListResponse
     */
