...
/**
 * This class stands for AddNewBatchResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyAddNewBatchResponse extends AbstractStructBase
{
    /**
     * The batchId
     * @var int
    ...
    public $batchId;
    /**
     * Constructor method for AddNewBatchResponse
     * @uses AbbyyAddNewBatchResponse::setBatchId()
     * @param int $batchId
     */
     ...
     * Set batchId value
     * @param int $batchId
     * @return \AbbyyBridge\StructType\AbbyyAddNewBatchResponse
     */
