...
/**
 * This class stands for CancelTask StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyCancelTask extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $taskId;
    /**
     * Constructor method for CancelTask
     * @uses AbbyyCancelTask::setSessionId()
     * @uses AbbyyCancelTask::setTaskId()
     * @param int $sessionId
     * @param int $taskId
     */
    public function __construct($sessionId = null, $taskId = null)
    {
        $this
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyCancelTask
     */
