...
/**
 * This class stands for OpenTask StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyOpenTask extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $taskId;
    /**
     * Constructor method for OpenTask
     * @uses AbbyyOpenTask::setSessionId()
     * @uses AbbyyOpenTask::setTaskId()
     * @param int $sessionId
     * @param int $taskId
     */
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyOpenTask
     */
