...
/**
 * This class stands for GetCurrentTaskResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetCurrentTaskResponse extends AbstractStructBase
{
    /**
     * The taskId
     * @var int
    ...
    public $taskId;
    /**
     * Constructor method for GetCurrentTaskResponse
     * @uses AbbyyGetCurrentTaskResponse::setTaskId()
     * @param int $taskId
     */
     ...
     * Set taskId value
     * @param int $taskId
     * @return \AbbyyBridge\StructType\AbbyyGetCurrentTaskResponse
     */
