...
/**
 * This class stands for GetRequestStatus StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetRequestStatus extends AbstractStructBase
{
    /**
     * The requestId
     * @var int
    ...
    public $requestId;
    /**
     * Constructor method for GetRequestStatus
     * @uses AbbyyGetRequestStatus::setRequestId()
     * @param int $requestId
     */
     ...
     * Set requestId value
     * @param int $requestId
     * @return \AbbyyBridge\StructType\AbbyyGetRequestStatus
     */
