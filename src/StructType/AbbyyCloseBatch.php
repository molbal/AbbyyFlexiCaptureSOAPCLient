...
/**
 * This class stands for CloseBatch StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyCloseBatch extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $batchId;
    /**
     * Constructor method for CloseBatch
     * @uses AbbyyCloseBatch::setSessionId()
     * @uses AbbyyCloseBatch::setBatchId()
     * @param int $sessionId
     * @param int $batchId
     */
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyCloseBatch
     */
