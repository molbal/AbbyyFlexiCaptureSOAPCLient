...
/**
 * This class stands for PostponeTask StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyPostponeTask extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $comment;
    /**
     * Constructor method for PostponeTask
     * @uses AbbyyPostponeTask::setSessionId()
     * @uses AbbyyPostponeTask::setTaskId()
     * @uses AbbyyPostponeTask::setComment()
     * @param int $sessionId
     * @param int $taskId
     * @param string $comment
     */
    public function __construct($sessionId = null, $taskId = null, $comment = null)
    {
        $this
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyPostponeTask
     */
