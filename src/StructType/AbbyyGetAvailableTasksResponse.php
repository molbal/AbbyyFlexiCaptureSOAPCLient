...
/**
 * This class stands for GetAvailableTasksResponse StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetAvailableTasksResponse extends AbstractStructBase
{
    /**
     * The tasks
    ...
    public $tasks;
    /**
     * Constructor method for GetAvailableTasksResponse
     * @uses AbbyyGetAvailableTasksResponse::setTasks()
     ...
     * Set tasks value
     * @param \AbbyyBridge\StructType\AbbyyTaskList $tasks
     * @return \AbbyyBridge\StructType\AbbyyGetAvailableTasksResponse
     */
