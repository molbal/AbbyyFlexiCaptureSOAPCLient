...
/**
 * This class stands for ProcessBatch StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyProcessBatch extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $batchId;
    /**
     * Constructor method for ProcessBatch
     * @uses AbbyyProcessBatch::setSessionId()
     * @uses AbbyyProcessBatch::setBatchId()
     * @param int $sessionId
     * @param int $batchId
     */
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyProcessBatch
     */
