...
/**
 * This class stands for GetAvailableQueues StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyGetAvailableQueues extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $projectId;
    /**
     * Constructor method for GetAvailableQueues
     * @uses AbbyyGetAvailableQueues::setSessionId()
     * @uses AbbyyGetAvailableQueues::setProjectId()
     * @param int $sessionId
     * @param int $projectId
     */
    public function __construct($sessionId = null, $projectId = null)
    {
        $this
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyGetAvailableQueues
     */
