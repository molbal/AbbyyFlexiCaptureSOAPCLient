 ...
 * @subpackage Structs
 */
class AbbyyDeleteDocumentResponse extends AbstractStructBase
{
    /**
     * The result
     * @var bool
     ...
     * @uses AbbyyDeleteDocumentResponse::setResult()
     * @param bool $result
     */
     ...
     * Set result value
     * @param bool $result
     * @return \AbbyyBridge\StructType\AbbyyDeleteDocumentResponse
     */
