...
/**
 * This class stands for CloseProject StructType
 * @package Abbyy
 * @subpackage Structs
 */
class AbbyyCloseProject extends AbstractStructBase
{
    /**
     * The sessionId
     * @var int
    ...
    public $projectId;
    /**
     * Constructor method for CloseProject
     * @uses AbbyyCloseProject::setSessionId()
     * @uses AbbyyCloseProject::setProjectId()
     * @param int $sessionId
     * @param int $projectId
     */
     ...
     * Set sessionId value
     * @param int $sessionId
     * @return \AbbyyBridge\StructType\AbbyyCloseProject
     */
